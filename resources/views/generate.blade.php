         ...
         <div class = "row">
            <div class = "col-md-8">
               ...
               <div id="target" >
                  ...
                  <div class="textbox" type="text" onclick="dragElement(this);" id="id_0" style="font-family: arial; z-index: 0; color: gray; position: absolute; top: 298px; left: 30px; font-weight: 500;" contenteditable="">18th Nov 2021</div>
                  <div class="textbox" type="text" onclick="dragElement(this);" id="id_1" style="font-family: arial; z-index: 1; color: gray; position: absolute; top: 398px; left: 28px; font-weight: 500;" contenteditable="">One Gram</div>
                  <div class="textbox" type="text" onclick="dragElement(this);" id="id_2" style="font-family: arial; z-index: 2; color: gray; position: absolute; top: 510px; left: 32px; font-weight: 500;" contenteditable="">Eight Gram</div>
                  <div class="textbox" type="text" onclick="dragElement(this);" id="id_3" style="font-family: myFirstFont; z-index: 3; color: gray; position: absolute; top: 571px; left: 255px; font-weight: 500;" contenteditable="">Address</div>
                  <img src="http://localhost/posteraks/rest-api/public/images/ivlogo.png" id="id_4" onclick="dragElement(this);" style="width: 20%; height: 20%; z-index: 5; overflow: hidden; position: absolute; top: 27px; left: 463px;">               
                </div>
            </div>
            
           <button type="button" id="foo">Capture</button>
